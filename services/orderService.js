...
const createCaedOrder = async (session) => {
  ...
  console.log(
    "🚀 ~ file: orderService.js:157 ~ createCaedOrder ~ session.client_reference_id:",
    session.client_reference_id
  );
  const shippingAddress = session.metadata;
  console.log(
    "🚀 ~ file: orderService.js:159 ~ createCaedOrder ~ session.metadata:",
    session.metadata
  );
  const orderPrice = session.amount_total / 100;
  console.log(
    "🚀 ~ file: orderService.js:161 ~ createCaedOrder ~ orderPrice:",
    orderPrice
  );
